...
- PsychoPy is an experiment building software, similiar to E-prime or MATLAB.  It is my preferred metod of creating experiments in the lab because it is (1) free, (2) has great documentation and help, and (3) is actively mantained.
  - Documentation: (http://psychopy.org/builder/builder.html)[http://psychopy.org/builder/builder.html]
  - Q&A Help site (new questions asked here): (https://discourse.psychopy.org/)[https://discourse.psychopy.org/]
  - Old Q&A Help site (no longer active): (https://groups.google.com/forum/#!forum/psychopy-users)[https://groups.google.com/forum/#!forum/psychopy-users]
